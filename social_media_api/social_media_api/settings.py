...
SECRET_KEY = 'django-insecure-60&-2h6))mt*_qcac5)c3p2o!w(^zfw4lmsh@k-!68e3(n!tpm'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MySQL'),
        'USER': os.getenv('jared'),
        'PASSWORD': os.getenv('Y@red3125'),
        'HOST': os.getenv('localhost'),
        'PORT': os.getenv('80', '5432'),
    }
}
